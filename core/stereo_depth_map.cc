...
//  cv::Mat disp8U2 = disp8U;

//  cv::medianBlur(disp8U, disp8U2, 7);
//  disp8U = disp8U2;
...
//  cv::kmeans(samples, 10, labels, cv::TermCriteria(CV_TERMCRIT_ITER | CV_TERMCRIT_EPS, 10, 0.01), 10, cv::KMEANS_PP_CENTERS, centers );
